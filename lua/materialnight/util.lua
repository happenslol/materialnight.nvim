local ts = require("materialnight.treesitter")
...
function M.onColorScheme()
  vim.cmd([[autocmd! MaterialNight]])
  vim.cmd([[augroup! MaterialNight]])
end
...
function M.autocmds(config)
  vim.cmd([[augroup MaterialNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorSchemePre * lua require("materialnight.util").onColorScheme()]])
...
function M.load(theme)
  ...
  vim.g.colors_name = "materialnight"
